...
class UserRegister(Resource):
    ...
    parser.add_argument('notification', type=str, required=False)
    parser.add_argument('login', type=str, required=False)
    parser.add_argument('hilook_visible', type=str, required=False)
    parser.add_argument('hangouts_visible', type=str, required=False)
    parser.add_argument('max_distance', type=str, required=False)
