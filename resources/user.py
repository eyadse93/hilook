...
class UserRegister(Resource):
    ...
    parser.add_argument('latitude', type=long, required=False)
    parser.add_argument('longitude', type=long, required=False)
    ...
    parser.add_argument('max_distance', type=long, required=False)
    ...
    parser.add_argument('birthdate', type=long, required=False)
